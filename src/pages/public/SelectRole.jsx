...
export default function SelectRole() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center">
      <div className="w-[50%] bg-white p-6 flex shadow-2xl">
        <div className="w-[50%] flex flex-col gap-10">
          <h1 className="text-3xl font-bold text-black">خد<span className='text-[#d75b19]'>ما</span>تك</h1>
          <p className='text-xs text-gary-500'>خدماتك منصة خدمات منزلية بتسهّل على العملاء طلب الحرفيين في أي وقت. من السباكة للكهرباء والنجارة، بنوفّرلك تجربة حجز سهلة وتواصل مباشر مع حرفيين موثوقين.</p>
