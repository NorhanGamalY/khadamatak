...
export default function ProfileDropdown({ onLogout, unreadMessages = 0 }) {
    ...
    <div ref={ref} className="relative">
      ...
      >
        <div className="relative">
          <Avatar size={36} />
          {unreadMessages > 0 && (
            <span className="absolute -top-1 -right-1 bg-[#d75b19] text-white text-[10px] rounded-full w-5 h-5 flex items-center justify-center font-bold z-10">
