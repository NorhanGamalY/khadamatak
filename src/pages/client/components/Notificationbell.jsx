      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
            ...
            {unread > 0 && (
              <span className="text-[12px] text-[#d75b19] font-semibold">
                {unread} جديد
              </span>
            )}
          </div>
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <div
                  ...
                  className={`flex gap-3 items-start px-4 py-3 cursor-pointer hover:bg-gray-50 transition border-b border-gray-50 last:border-0 ${
                ...
                >
                  <div
                    ...
                    style={{
                      width: 36,
                      height: 36,
                      background: !n.isRead ? "#fff3eb" : "#f3f4f6",
                      color: !n.isRead ? "#d75b19" : "#6b7280",
                    }}
                  >
                    <FiBell size={16} />
                  </div>
